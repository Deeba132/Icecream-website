...
<div class="container">
      <div class="row">
        <?php 
        $query="SELECT * FROM `product_first` WHERE id >= 13
        ORDER BY id ASC ";
            ...
            <form action="home.php?action=add&id=<?php echo $row['id'];?>" method="post">
             <div class="card" style="width: 18rem;border-radius:50px;background-color:white;height:430px;padding-left:10px;" >
                  ...
                  <div class="card-body" style="border-radius:50px;" >
                      <h5 class="card-title" style="width:150px;"><b style="color:black;font-size:20px;letter-spacing:0.2px;"><?php echo $row["name"];?></b></h5>
                      <br>
                      <p class="card-text"><b style="color:black;">Price:<?php echo $row["price"];?></b></p>
                          ...
                          <input type="number" id="quantity" placeholder="1" style="width:30px;border:3px solid black; border-radius:5px;"name="quantity" min="1" max="10">
